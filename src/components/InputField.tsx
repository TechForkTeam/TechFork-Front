...
//           <input
//             type="text"
//             className={`w-full rounded-xl  border  pl-3 pr-15 body-md-500 focus:outline-none  ${errorMsg ? "!border-rd-500" : "focus:border-active border-gray-200"} ${className} ${disabled ? "!border-gray-200 cursor-not-allowed" : ""}`}
//             {...register}
//             {...props}
//             placeholder={placeholder}
//             disabled={disabled}
